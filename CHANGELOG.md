...
All notable changes to `Tiryaq/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/Tiryaq/git-commit-checker/pull/10)
